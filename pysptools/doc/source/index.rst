...
This version have an experimental module named **ml** (see the Machine Learning section below). 
...
will take time to fix. If you like hyper-parameters, you will be served!
